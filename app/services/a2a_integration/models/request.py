...
from app.services.a2a_integration.models.json_rpc import JSONRPCRequest, JSONRPCResponse

# Task-related parameter and return models
from app.services.a2a_integration.models.task import Task, TaskSendParams, TaskQueryParams
